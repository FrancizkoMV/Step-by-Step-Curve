...
function renderInputs() {
  ...
  if (totalWidth <= 0) {
    container.innerHTML = '<div style="padding: 12px; color: #64748b; text-align: center; font-size: 0.85rem;">Mide e ingresa el <b>Ancho Total</b> arriba para desplegar las casillas de medición.</div>';
    return;
  }
...
// Inicialización automática inmediata al cargar la app
